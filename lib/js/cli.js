...
Options:
  --dialect NAME         a bundled dialect: cll-ebnf (default), bpfk, experimental, zantufa, notation
...
function parseArguments(argv) {
  /** @type {Command} */
  const command = { command: argv[0] || "help", words: [], dialect: "cll-ebnf", features: [], withoutFeatures: [], format: "brackets", showElided: false, autoFeatures: true };
