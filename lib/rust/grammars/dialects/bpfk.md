...
The CLL dialect with the word-form grammar the definition effort approved,
appendix A2 of the 1.3 editions of *The Complete Lojban Language*, in place
of chapter 4's. [`../words/bpfk.md`](../words/bpfk.md) lists how the two
differ; every other stage is the CLL dialect's
([`cll.md`](cll.md)).
