...
delimiter
≔ $c(cmavo-shape) <tags($c)> | $b(brivla-shape) <tags($b)> | cmevla-shape <∅> | $l(lerfu-word) <tags($l)> ;
...
```ebnf
lohu-quote
≔ $m(lohu-marker) PAUSE $content(lohu-stream) PAUSE $e(lehu-marker) <tags($m) ∪ "onset" ∪ "continued">
| $m(lohu-marker) [PAUSE] $e(lehu-marker) <tags($m) ∪ "onset" ∪ "continued">
: "le'u" ∉ words($content)
⇒ $m, $e <"LEhU"> ;
