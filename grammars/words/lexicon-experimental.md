...
```ebnf
lexicon
≔ lexicon-a | lexicon-b | lexicon-c | lexicon-d | lexicon-e | lexicon-f | lexicon-g | lexicon-i | lexicon-j | lexicon-k | lexicon-l | lexicon-m | lexicon-n | lexicon-o | lexicon-p | lexicon-r | lexicon-s | lexicon-t | lexicon-u | lexicon-v | lexicon-x | lexicon-y | lexicon-z ;
```
